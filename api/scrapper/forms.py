...
class ScraperSourceForm(forms.ModelForm):
    manual_mode = forms.BooleanField(
        required=False,
        label='Inserir conteúdo manualmente'
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            'title_selector': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Ex: h1.article-title, .post-title'
            }),
            'content_selector': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Ex: div.article-content, .post-body'
            }),
            'image_selector': forms.TextInput(attrs={
                'class': 'form-control',

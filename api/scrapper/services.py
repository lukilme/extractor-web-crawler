...
class NewsScraperService:
    ...
    def scrape(self):
        self.job = ScraperJob.objects.create(
            source=self.source, started_by=self.user, status="running"
        )
        ...
        try:
            ...
            if news_data:
                ...
                return {"success": True, "news_post": news_post, "job": self.job}
            else:
            ...
            return {"success": False, "error": str(e), "job": self.job}
